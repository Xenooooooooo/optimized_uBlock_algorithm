...
void uBlock_256_Encrypt(unsigned char *plain, unsigned char *cipher, int round)
{
    ...
    __m256i c5_and_c7 = _mm256_setr_epi8(0, 2, 4, 6, 8, 10, 12, 14, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 17,19,21,23,25,27,29,31,0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80);
    __m256i c6_and_c8 = _mm256_setr_epi8(0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0, 2, 4, 6, 8, 10, 12, 14, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 17,19,21,23,25,27,29,31);

    __m256i L1_and_L3_En = _mm256_setr_epi8(4, 5, 14, 15, 0x80, 0x80, 0x80, 0x80, 6, 7, 12, 13, 0x80, 0x80, 0x80, 0x80,   18, 19, 24, 25, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 26, 27, 16, 17);
    __m256i L2_and_L4_En = _mm256_setr_epi8(0x80, 0x80, 0x80, 0x80, 0, 1, 10, 11, 0x80, 0x80, 0x80, 0x80, 2, 3,  8, 9,    0x80, 0x80, 0x80, 0x80,30,31,20,21,28,29,22,23, 0x80, 0x80, 0x80, 0x80);
    __m256i L5_and_L7_En = _mm256_setr_epi8(12,13,0x80, 0x80, 2,3,0x80, 0x80, 0x80, 0x80, 8,9,4,5,0x80, 0x80,30,31,16,17,0x80,0x80,0x80,0x80,0x80,0x80,22,23,0x80,0x80,26,27);
    __m256i L6_and_L8_En = _mm256_setr_epi8(0x80, 0x80, 6,7,0x80, 0x80, 8,9,2,3,0x80, 0x80, 0x80, 0x80, 14,15, 0x80,0x80,0x80,0x80,26,27,20,21,28,29,0x80,0x80,16,17,0x80,0x80);
    ...
    t1 = _mm256_unpacklo_epi64(state1, state2);             //////////revised
    ...
    _mm256_storeu_si256((__m256i*)cipher, t1);
}
...
void uBlock_256_Decrypt(unsigned char *cipher, unsigned char *plain, int round)
{
    ...
    __m256i L1_and_L3_De = _mm256_setr_epi8(0x80, 0x80, 0x80, 0x80, 0, 1, 8, 9, 0x80, 0x80, 0x80, 0x80, 10, 11, 2, 3,      20, 21, 28, 29, 0x80, 0x80, 0x80, 0x80, 30, 31, 22, 23, 0x80, 0x80, 0x80, 0x80);
    __m256i L2_and_L4_De = _mm256_setr_epi8(14, 15, 0, 1, 0x80, 0x80, 0x80, 0x80, 2, 3, 12, 13, 0x80, 0x80, 0x80, 0x80,    0x80, 0x80, 0x80, 0x80, 22, 23, 26, 27, 0x80, 0x80, 0x80, 0x80, 24, 25, 20, 21);
    __m256i L5_and_L7_De = _mm256_setr_epi8(0x80, 0x80, 4,5,12,13,0x80, 0x80, 10,11,0x80, 0x80, 0,1,0x80, 0x80,            0x80, 0x80, 24,25,0x80, 0x80, 18,19, 22,23,0x80, 0x80, 0x80, 0x80, 30,31);
    __m256i L6_and_L8_De = _mm256_setr_epi8(2,3,0x80, 0x80, 0x80, 0x80, 10,11,0x80, 0x80, 14,15,0x80, 0x80, 0,1,             28,29,0x80, 0x80, 22,23,0x80, 0x80, 0x80, 0x80, 20,21,24,25,0x80, 0x80);
...
int Crypt_Enc_Block(unsigned char *input, int in_len, unsigned char *output, unsigned char *key)
{
...
int Crypt_Dec_Block(unsigned char *input,int in_len, unsigned char *output, unsigned char *key)
{
    uBlock_256_KeySchedule(key);
...
int Crypt_Enc_Block_CBC(unsigned char *input, int in_len, unsigned char *output, int *out_len, unsigned char *key)
{
    int g, j;
...
int Crypt_Dec_Block_CBC(unsigned char *input,int in_len, unsigned char *output,int *out_len, unsigned char *key)
{
    int g, j;
...
int main()
{
    ...
    for(i = 0; i < 10; i++)
    {
        ...
        total += (double)total_bits / (times * 1024 * 1024);
    }
