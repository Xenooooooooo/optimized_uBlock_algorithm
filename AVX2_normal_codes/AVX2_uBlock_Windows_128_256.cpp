...
unsigned char RC[24][32] = {0x9,0x8,0x8,0xc,0xc,0x9,0xd,0xd,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0, 0x9,0x8,0x8,0xc,0xc,0x9,0xd,0xd,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
                            ...
                            0x8,0x2,0x9,0x6,0xd,0x3,0xc,0x7,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0, 0x8,0x2,0x9,0x6,0xd,0x3,0xc,0x7,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
                            0xc,0x5,0xd,0x1,0x9,0x4,0x8,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0, 0xc,0x5,0xd,0x1,0x9,0x4,0x8,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
                            0x4,0xa,0x5,0xe,0x1,0xb,0x0,0xf,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0, 0x4,0xa,0x5,0xe,0x1,0xb,0x0,0xf,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
                            0x5,0x5,0x4,0x1,0x0,0x4,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0, 0x5,0x5,0x4,0x1,0x0,0x4,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
                            0x6,0xb,0x7,0xf,0x3,0xa,0x2,0xe,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0, 0x6,0xb,0x7,0xf,0x3,0xa,0x2,0xe,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
                            0x1,0x7,0x0,0x3,0x4,0x6,0x5,0x2,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0, 0x1,0x7,0x0,0x3,0x4,0x6,0x5,0x2,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
                            0xe,0xf,0xf,0xb,0xb,0xe,0xa,0xa,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0, 0xe,0xf,0xf,0xb,0xb,0xe,0xa,0xa,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
                            0x1,0xf,0x0,0xb,0x4,0xe,0x5,0xa,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0, 0x1,0xf,0x0,0xb,0x4,0xe,0x5,0xa,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0};

void uBlock_256_KeySchedule(unsigned char *key, int plen)
{
    int i;

    __m256i S_first_SK_second     = _mm256_setr_epi8(7,4,9,12,11,10,13,8,15,14,1,6,0,3,2,5,0,2,4,6,8,10,12,14,3,1,7,5,11,9,15,13);

    __m256i c1 = _mm256_setr_epi8(0, 0x80, 1, 0x80, 2, 0x80, 3, 0x80, 4, 0x80, 5, 0x80, 6, 0x80, 7, 0x80, 16, 0x80, 17, 0x80, 18, 0x80, 19, 0x80 ,20, 0x80 ,21, 0x80, 22, 0x80 ,23, 0x80);
    __m256i c2 = _mm256_setr_epi8(0x80, 0, 0x80, 1, 0x80, 2, 0x80, 3, 0x80, 4, 0x80, 5, 0x80, 6, 0x80, 7, 0x80, 16, 0x80, 17, 0x80, 18, 0x80, 19, 0x80, 20, 0x80, 21, 0x80, 22, 0x80, 23);
    __m256i c3 = _mm256_setr_epi8(8, 0x80, 9, 0x80, 10, 0x80, 11, 0x80, 12, 0x80, 13, 0x80, 14, 0x80, 15, 0x80, 24, 0x80, 25, 0x80, 26, 0x80, 27, 0x80, 28, 0x80, 29, 0x80, 30, 0x80, 31, 0x80);
    __m256i c4 = _mm256_setr_epi8(0x80, 8, 0x80, 9, 0x80, 10, 0x80, 11, 0x80, 12, 0x80, 13, 0x80, 14, 0x80, 15, 0x80, 24, 0x80, 25, 0x80, 26, 0x80, 27, 0x80, 28, 0x80, 29, 0x80, 30, 0x80, 31);

    __m256i PK = _mm256_setr_epi8(10,5,15,0,2,7,8,13,1,14,4,12,9,11,3,6,24,25,26,27,28,29,30,31,16,17,18,19,20,21,22,23);

    __m256i state1, state2, k, t1, t2, t3, t4;

    __m128i hi_0, hi_1, lo_0, lo_1;

    state2 = _mm256_loadu_si256((__m256i*)key);     // OK
    state1 = _mm256_srli_epi16(state2, 4);      // OK
    state1 = _mm256_and_si256(state1, con);         // OK, equals to the original code's state1 || state3
    state2 = _mm256_and_si256(state2, con);         // OK, equals to the original code's state2 || state4
    t1 = _mm256_shuffle_epi8(state1, c1);           // OK, equals to the original code's dilute of the state1 and state3's 1st half (0 front)
    t2 = _mm256_shuffle_epi8(state2, c2);           // OK, equals to the original code's dilute of the state2 and state4's 1st half (0  end )
    t3 = _mm256_shuffle_epi8(state1, c3);           // OK, equals to the original code's dilute of the state1 and state3's 2nd half (0 front)
    t4 = _mm256_shuffle_epi8(state2, c4);           // OK, equals to the original code's dilute of the state2 and state4's 2nd half (0  end )
    state1 = _mm256_xor_si256(t1, t2);              // OK, equals to the original code's state1 || state3
    state2 = _mm256_xor_si256(t3, t4);              // OK, equals to the original code's state2 || state4
    ...
    for (i = 1; i <= 24; i++)
    {
        ...
        k = _mm256_loadu_si256((__m256i*)RC[i - 1]);                                            // OK
        k = _mm256_xor_si256(state1, k);                                                            // OK
        k = _mm256_shuffle_epi8(S_first_SK_second, k);                                              // now, in the original form, k = S(state1 xor RC) || SK(state2)
        k = _mm256_xor_si256(k, state2);                                                            // now, in the original form, k = (state3 xor (S(state1 xor RC))) || state4 xor (SK(state2))
...
void uBlock_128_Encrypt(unsigned char *plain_1, unsigned char *plain_2, unsigned char *cipher_1, unsigned char *cipher_2, int round)
{
    int i;
    ...
    __m256i c1 = _mm256_setr_epi8(0, 0x80, 1, 0x80, 2, 0x80, 3, 0x80, 4, 0x80, 5, 0x80, 6, 0x80, 7, 0x80,0, 0x80, 1, 0x80, 2, 0x80, 3, 0x80, 4, 0x80, 5, 0x80, 6, 0x80, 7, 0x80);
    __m256i c2 = _mm256_setr_epi8(0x80, 0, 0x80, 1, 0x80, 2, 0x80, 3, 0x80, 4, 0x80, 5, 0x80, 6, 0x80, 7,0x80, 0, 0x80, 1, 0x80, 2, 0x80, 3, 0x80, 4, 0x80, 5, 0x80, 6, 0x80, 7);
    __m256i c3 = _mm256_setr_epi8(8, 0x80, 9, 0x80, 10, 0x80, 11, 0x80, 12, 0x80, 13, 0x80, 14, 0x80, 15, 0x80,8, 0x80, 9, 0x80, 10, 0x80, 11, 0x80, 12, 0x80, 13, 0x80, 14, 0x80, 15, 0x80);
    __m256i c4 = _mm256_setr_epi8(0x80, 8, 0x80, 9, 0x80, 10, 0x80, 11, 0x80, 12, 0x80, 13, 0x80, 14, 0x80, 15,0x80, 8, 0x80, 9, 0x80, 10, 0x80, 11, 0x80, 12, 0x80, 13, 0x80, 14, 0x80, 15);

    __m256i c5 = _mm256_setr_epi8(0, 2, 4, 6, 8, 10, 12, 14, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80,0, 2, 4, 6, 8, 10, 12, 14, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80);
    __m256i c6 = _mm256_setr_epi8(0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0, 2, 4, 6, 8, 10, 12, 14,0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0, 2, 4, 6, 8, 10, 12, 14);
    __m256i c7 = _mm256_setr_epi8(1, 3, 5, 7, 9, 11, 13, 15, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80,1, 3, 5, 7, 9, 11, 13, 15, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80);
...
//    printf("state2: %016x %016x %016x %016x\n", state2[0], state2[1], state2[2], state2[3]);
    ...
    _mm256_storeu2_m128i((__m128i*)cipher_1, (__m128i*)cipher_2, t1);
//    printf("\n%02x\n", key[2]);
}

void uBlock_128_Decrypt(unsigned char *cipher_1, unsigned char *cipher_2, unsigned char *plain_1, unsigned char *plain_2, int round)
{
    int i;
...
//        printf("state2: %016x %016x %016x %016x\n", state2[0], state2[1], state2[2], state2[3]);
    ...
    _mm256_storeu2_m128i((__m128i*)plain_1, (__m128i*)plain_2, t1);
}

int Crypt_Enc_Block(unsigned char *input_1, unsigned char *input_2, int in_len, unsigned char *output_1, unsigned char *output_2, int *out_len, unsigned char *key, int keylen)
{
    int g;
    ...
    {
        uBlock_128_Encrypt(input_1+g*16, input_2+g*16, output_1+g*16, output_2+g*16, 24);
...
int Crypt_Dec_Block(unsigned char *input_1, unsigned char *input_2, int in_len, unsigned char *output_1, unsigned char *output_2, int *out_len, unsigned char *key, int keylen)
{
    int g;
    ...
    for (g = 0; g < in_len / 16; g++)
    {
        uBlock_128_Decrypt(input_1+g*16, input_2+g*16, output_1+g*16, output_2+g*16, 24);
    }
    *out_len = in_len - in_len % 16;
...
int Key_Schedule(unsigned char *key, int keylen, int direction, unsigned char *subkey)
{
    int i, j;
...
int Crypt_Enc_Block_CBC(unsigned char *input_1, unsigned char *input_2, int in_len, unsigned char *output_1, unsigned char *output_2, int *out_len, unsigned char *key, int keylen)
{
    int g, j;
...
int Crypt_Dec_Block_CBC(unsigned char *input_1, unsigned char *input_2, int in_len, unsigned char *output_1,  unsigned char *output_2, int *out_len, unsigned char *key, int keylen)
{
    int g, j;
...
int main()
{
    ...
    unsigned char plain_1[16]   = {0x01,0x23,0x45,0x67,0x89,0xAB,0xCD,0xEF,0xFE,0xDC,0xBA,0x98,0x76,0x54,0x32,0x10};
    unsigned char plain_2[16]   = {0x01,0x23,0x45,0x67,0x89,0xAB,0xCD,0xEF,0xFE,0xDC,0xBA,0x98,0x76,0x54,0x32,0x10};
    ...
    for(i = 0; i < 10; i++)
    {
        ...
        printf("%f\n", (double)2 * total_bits / (times * 1024 * 1024));
...
/////////////------------(1 + n) long text test----------/////////////////
    ...
    for(i = 0; i < 10; i++)
    {
        op = clock();
        for(r = 0; r < 1024; r ++)
            Crypt_Enc_Block(long_plain_1, long_plain_2, 262144, long_cipher_1, long_cipher_2, &j, key, 16);
        ed = clock();
        times = (double)(ed - op) / CLOCKS_PER_SEC;
        printf("%f mbps\n", (double)2 * total_mb / times);
        total += (double)2 * total_mb / times;
    }
    ...
    for(i = 0; i < 10; i++)
    {
        op = clock();
        for(r = 0; r < 1024; r ++)
            Crypt_Dec_Block(long_cipher_1, long_cipher_2, 262144, long_plain_1, long_plain_2, &j, key, 16);
        ed = clock();
        times = (double)(ed - op) / CLOCKS_PER_SEC;
        printf("%f mbps\n", (double)2 * total_mb / times);
        total += (double)2 * total_mb / times;
...
/////////------------CBC test----------/////////////////
    ...
    for(i = 0; i < 10; i++)
    {
        op = clock();
        for(r = 0; r < 1024; r ++)
            Crypt_Enc_Block_CBC(long_plain_1, long_plain_2, 262144, long_cipher_1, long_cipher_2, &j, key, 16);
        ed = clock();
        times = (double)(ed - op) / CLOCKS_PER_SEC;
        printf("%f mbps\n", (double)2 * total_mb / times);
        total += (double)2 * total_mb / times;
    ...
    for(i = 0; i < 10; i++)
    {
        op = clock();
        for(r = 0; r < 1024; r ++)
            Crypt_Dec_Block_CBC(long_cipher_1, long_cipher_2, 262144, long_plain_1, long_plain_2, &j, key, 16);
        ed = clock();
        times = (double)(ed - op) / CLOCKS_PER_SEC;
        printf("%f mbps\n", (double)2 * total_mb / times);
        total += (double)2 * total_mb / times;
