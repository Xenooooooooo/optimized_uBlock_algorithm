...
unsigned char Subkey_1[17][32], Subkey_2[17][32];
...
unsigned char RC[16][32] = {0x9,0x8,0x8,0xc,0xc,0x9,0xd,0xd,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x9,0x8,0x8,0xc,0xc,0x9,0xd,0xd,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
                            0xf,0x0,0xe,0x4,0xa,0x1,0xb,0x5,0x0,0x0,0x0,0x0,0x0,0x50,0x0,0x0,0xf,0x0,0xe,0x4,0xa,0x1,0xb,0x5,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
...
inline void uBlock_128_KeySchedule(unsigned char *key_1)
{
    int i;
    ...
    state2 = _mm256_loadu2_m128i((__m128i*)key_1, (__m128i*)key_1);
...
inline int Crypt_Enc_Block(unsigned char *input_1, unsigned char *input_2, unsigned char *input_3, unsigned char *input_4, int in_len, unsigned char *output_1, unsigned char *output_2, unsigned char *output_3, unsigned char *output_4, unsigned char *key_1)
{
    uBlock_128_KeySchedule(key_1);
...
inline int Crypt_Dec_Block(unsigned char *input_1, unsigned char *input_2, unsigned char *input_3, unsigned char *input_4, int in_len, unsigned char *output_1, unsigned char *output_2, unsigned char *output_3, unsigned char *output_4, unsigned char *key_1)
{
    uBlock_128_KeySchedule(key_1);
...
///////////////-----------------------------///////////////// (1 + 1) * n test
    ...
    for(i = 0; i < 10; i++)
    {
        ...
        for(r = 0; r < 10000000; r++)
            Crypt_Enc_Block(plain_1, plain_2, plain_3, plain_4, 16, cipher_1, cipher_2, cipher_3, cipher_4, key_1);
        ed = clock();
...
/////////////////////////////////////////////////////////////////////////
    ...
    for(i = 0; i < 10; i++)
    {
        op = clock();
        for(r = 0; r < 10000000; r++)
            Crypt_Dec_Block(cipher_1, cipher_2, cipher_3, cipher_4, 16, plain_1, plain_2, plain_3, plain_4, key_1);
        ed = clock();
        times = (double)(ed - op) / CLOCKS_PER_SEC;
        printf("%f\n", 4 * (double)total_bits / (times * 1024 * 1024));
        total += 4 * (double)total_bits / (times * 1024 * 1024);
...
/////////////------------(1 + n) long text test----------/////////////////
    ...
    for(i = 0; i < 10; i ++)
    {
        op = clock();
        for(r = 0; r < 1024; r ++)
            Crypt_Enc_Block(long_plain_1, long_plain_2, long_plain_3, long_plain_4, 262144, long_cipher_1, long_cipher_2, long_cipher_3, long_cipher_4, key_1);
        ed = clock();
        times = (double)(ed - op) / CLOCKS_PER_SEC;
    ...
    for(i = 0; i < 10; i ++)
    {
        op = clock();
        for(r = 0; r < 1024; r ++)
            Crypt_Dec_Block(long_cipher_1, long_cipher_2, long_cipher_3, long_cipher_4, 262144, long_plain_1, long_plain_2, long_plain_3, long_plain_4, key_1);
        ed = clock();
        times = (double)(ed - op) / CLOCKS_PER_SEC;
        printf("%f\n", (double)total_mb / times);
        total += (double)total_mb / times;
